odoo.define("evtc_lmfs.options", function (require) {
    "use strict";
    ...
    class OptionsModal {
        ...
        setFieldSelections_() {
            ...
            // Polyline visibility
            this.showAnticipatedRoutePolylineField.checked = this.options.showAnticipatedRoutePolyline;

            this.showTakenRoutePolylineField.checked = this.options.showTakenRoutePolyline;

            // Vehicle icon
            document.getElementById(`vehicle-icon-option-${this.options.vehicleIcon || 'defaultVehicleIcon'}`)
            ...
            // Destination icon
            document.getElementById(`destination-icon-option-${this.options.destinationIcon || 'defaultDestinationIcon'}`)
                .setAttribute('selected', 'selected');
