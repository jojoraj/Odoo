odoo.define('evtc_location._token_session', function(require) {
    'use strict';

    var $_ajax = require('web.ajax');
    const SessionTokenImplement = require('evtc_location.map');
    const _Token = SessionTokenImplement.evtcLocationMap;
