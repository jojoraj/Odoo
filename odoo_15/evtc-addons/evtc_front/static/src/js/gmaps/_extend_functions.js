odoo.define('lcas.evtc._extendFunctions', function(require) {
    'use strict';
    const _extendFunctions = require('evtc_front.reservations');
    const _extend = _extendFunctions.evtcArkeupMap;
